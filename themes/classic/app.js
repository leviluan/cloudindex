...
// Inicialize a página e carregue os recursos necessários
function init(){
...
function utc2beijing(utc_datetime) {
    // Converter para o formato de hora normal Ano-Mês-Dia Hora: Minuto: Segundo
    ...
    // O processamento se torna um carimbo de data / hora
    timestamp = new Date(Date.parse(new_datetime));
    timestamp = timestamp.getTime();
    timestamp = timestamp/1000;

    // Aumentado em 8 horas, o horário de Pequim é oito fusos horários a mais que o horário UTC
    var unixtimestamp = timestamp+8*60*60;

    // Timestamp para o tempo
...
// bytes Conversão adaptativa para KB,MB,GB
